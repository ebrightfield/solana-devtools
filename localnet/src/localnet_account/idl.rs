...
pub fn parse_idl_from_lib_rs<P: AsRef<Path>>(lib_rs: P) -> Result<Idl> {
    anchor_syn::idl::file::parse(
        ...
        .ok_or(LocalnetConfigurationError::IdlParseError("parse function returned no IDL".to_string()))
}

pub fn serialize_idl_for_on_chain(
    idl: &Idl,
    ...
    header.try_serialize(&mut account_data)
