...
/// A slightly more "batteries included" version of Anchor SPL `TokenAccount`,
/// with some builder methods and a non-empty definition of [AnchorSerialize].
...
/// A slightly more "batteries included" version of Anchor SPL `Mint`,
/// with some builder methods and a non-empty definition of [AnchorSerialize].
#[derive(Clone, Debug, Default, PartialEq)]
