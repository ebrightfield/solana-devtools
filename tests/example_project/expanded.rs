...
pub mod program {
    ...
    impl ::core::clone::Clone for TestProgram {
        #[inline]
        fn clone(&self) -> TestProgram {
            TestProgram
        }
    }
    impl anchor_lang::Id for TestProgram {
        fn id() -> Pubkey {
            ID
        }
    }
...
mod __private {
                        ...
                        anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                ...
                                error_origin: Some(
                                    anchor_lang::error::ErrorOrigin::Source(anchor_lang::error::Source {
                                        filename: "programs/test-program/src/lib.rs",
                                        line: 5u32,
                                    }),
                                ),
    ...
    pub mod __global {
        ...
        pub fn initialize(
            ...
            let result = test_program::initialize(
